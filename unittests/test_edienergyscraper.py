...
class TestEdiEnergyScraper:
    ...
    def test_file_download_file_does_not_exists_yet(
        ...
        isfile_mocker = mocker.patch("edienergyscraper.os.path.isfile", return_value=False)
    ...
    def test_pdf_download_pdf_exists_already(
        ...
        isfile_mocker = mocker.patch("edienergyscraper.os.path.isfile", return_value=True)
